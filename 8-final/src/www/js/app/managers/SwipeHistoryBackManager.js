import {Disposable} from 'lavaca';
import {Transition, Transform, ViewManager as viewManager} from 'lavaca';

export let SwipeHistoryBackManager = Disposable.extend(function SwipeHistoryBackManager() {
